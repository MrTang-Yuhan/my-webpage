...
## 追寻无限上下文的 Agent Memory 是否有意义？是否需要引入遗忘？

现在的 Agent Memory 有一个很奇怪的现状，就是追寻无限上下文的 agent memory。但是，这种有意义吗？我们是否真的需要无限上下文？

这就引申到另外一个问题，Agent Memory 又是否需要引入遗忘机制呢？遗忘是为了更好的专注。
