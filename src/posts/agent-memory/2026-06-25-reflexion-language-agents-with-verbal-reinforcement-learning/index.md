...
![图1: Reflexion 在决策、编程和推理任务上的应用概览](fig1_overview.png)
...
![图2: Reflexion 框架图与强化算法伪代码](fig2_framework.png)
...
![图3: ALFWorld 实验结果](fig3_alfworld_results.png)
...
![图5: ALFWorld 轨迹示例](fig5_alfworld_trajectory.png)
...
![图4: HotPotQA 实验结果](fig4_hotpotqa_results.png)
...
![图7: HotPotQA 推理示例](fig7_hotpotqa_example.png)
...
![表1: 各基准测试 Pass@1 准确率](table1_pass_at_1.png)
...
![表2: 整体准确率与测试生成性能](table2_test_performance.png)
...
![表3: HumanEval Rust 消融实验](table3_ablation.png)
...
![相关工作对比表](related_work_tables.png)
...
![图6: WebShop 实验结果](fig6_webshop_results.png)
