...
![SVD 几何变换示意：单位圆经 V^T 旋转、Σ 缩放、U 旋转后变为椭圆](./fig_1_svd_geometric_transform.png)
...
![低秩逼近示意：原始矩阵与秩1、秩2逼近及误差对比](./fig_2_low_rank_approximation.png)
...
![奇异值衰减曲线与累积能量保留率](./fig_3_singular_value_decay.png)
...
![SVD 矩阵分解结构：U、Σ、V^T 的维度关系与紧凑形式](./fig_4_svd_matrix_structure.png)
